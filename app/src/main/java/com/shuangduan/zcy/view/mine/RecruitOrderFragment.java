 ...
 * @class describe
 */
public class RecruitOrderFragment extends BaseLazyFragment {
    @BindView(R.id.rv)
    RecyclerView rv;
    ...
    public static RecruitOrderFragment newInstance() {

        Bundle args = new Bundle();

        RecruitOrderFragment fragment = new RecruitOrderFragment();
