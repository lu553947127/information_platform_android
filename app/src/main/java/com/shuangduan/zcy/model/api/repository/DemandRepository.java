...
public class DemandRepository extends BaseRepository {
    ...
    public void demandSubstanceRelease(MutableLiveData<DemandReleaseBean> liveData, MutableLiveData<String> pageStateLiveData, int user_id, String material_name, String count, String project_name, String address,
                              String acceptance_price, String tel, String realName, String start_time, String end_time){
        request(apiService.demandSubstanceRelease(user_id, material_name, count, project_name, address, acceptance_price, tel, realName, start_time, end_time)).setData(liveData).setPageState(pageStateLiveData).send();
    }
    public void demandBuyerRelease(MutableLiveData<DemandReleaseBean> liveData, MutableLiveData<String> pageStateLiveData, int user_id, String material_name, String count, String address,
                              String acceptance_price, String tel, String realName, int way, String start_time, String end_time){
        request(apiService.demandBuyerRelease(user_id, material_name, count, address, acceptance_price, tel, realName, way, start_time, end_time)).setData(liveData).setPageState(pageStateLiveData).send();
    }
