 ...
 * @Package: com.shuangduan.zcy.weight
 * @ClassName: HeadZoomScrollView
 * @Description: 滑到头部或尾部可伸缩放大效果
 * @Author: 鹿鸿祥
 * @CreateDate: 2019/10/22 13:55
 * @UpdateUser: 鹿鸿祥
 * @UpdateDate: 2019/10/22 13:55
 * @UpdateRemark: 注意使用的时候需要放大的view,一般是第一个RelativeLayout或者LinearLayout。要加上  android:layout_gravity="center_horizontal"
 * @Version: 1.0
 */
