 ...
 * @Package: com.shuangduan.zcy.adminManage.adapter
 * @ClassName: UseStatueAdapter
 * @Description: java类作用描述
 * @Author: 鹿鸿祥
 * @CreateDate: 2019/10/29 11:37
 * @UpdateUser: 鹿鸿祥
 * @UpdateDate: 2019/10/29 11:37
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class UseStatueAdapter extends BaseQuickAdapter<TurnoverTypeBean.UseStatusBean, BaseViewHolder> {
    private int is_select;
    public UseStatueAdapter(int layoutResId, @Nullable List<TurnoverTypeBean.UseStatusBean> data) {
    ...
    @Override
    protected void convert(BaseViewHolder helper, TurnoverTypeBean.UseStatusBean item) {
