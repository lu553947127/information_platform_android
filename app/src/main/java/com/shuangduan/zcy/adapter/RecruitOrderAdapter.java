 ...
 * @class describe
 */
public class RecruitOrderAdapter extends BaseQuickAdapter<OrderListBean.ListBean, BaseViewHolder> {
    public RecruitOrderAdapter(int layoutResId, @Nullable List<OrderListBean.ListBean> data) {
