...
public class SupplierAdapter extends BaseQuickAdapter<SupplierBean.ListBean, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, SupplierBean.ListBean item) {
        helper.setText(R.id.tv_name, item.getName())
                ...
                .setText(R.id.tv_area, String.format(mContext.getString(R.string.format_supplier), item.getServe_address()))
                .setText(R.id.tv_production, String.format(mContext.getString(R.string.format_supplier), item.getProduct()))
