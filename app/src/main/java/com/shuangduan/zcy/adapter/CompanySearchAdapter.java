 ...
 * @class describe
 */
public class CompanySearchAdapter extends BaseQuickAdapter<String, BaseViewHolder> {
    private String keyword;

    public CompanySearchAdapter(int layoutResId, @Nullable List<String> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, String item) {
        helper.setText(R.id.tv_title, setSpan(item));
    }
